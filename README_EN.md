...
The image above is a repository-made **input test image**; the [matching pure CSS output](docs/contour-study.html) can be downloaded and opened directly. It contains 317 contours and 59 gradients; the HTML is about 471 KiB. The image in this README is for illustration only — the generated HTML never references it.
